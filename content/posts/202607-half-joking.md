...
Tone indicators are definitely among my favourite features of written language used on the internet. During an in-person conversation, the tone of voice, facial expression and overall body language of your conversation partner would (ideally) give away if they're joking, being sarcastic or something of similar nature. When you lead a conversation on the internet though, it usually takes place in written form -- meaning these cues (which might already be difficult to spot for some) get completely lost. Thankfully -- given that the writer is enlightened enough to use them -- tone indicators come to the rescue and bluntly state (or _indicate_, if you may), well, the _tone_ of the message. But... are they really as unambiguous as they like to pretend to be? _(spoiler alert: no)_
...
1. A text whose literal meaning isn't true (or meant sincerely), but the point behind it, or the problem illustrated by it, is a sincere point or an actual problem.
    - example: "A friend is the best invention since ChatGPT was made available to the general public" (obviously ChatGPT was invented after the concept of friendship, which is the funny part -- the true part is that a friend is better to talk to than ChatGPT);
    - example 2: "Unfortunately, a 2 hour monologue about why .docx is a horrible format will now have to take place." (The serious part is that I really don't like the .docx format. I am not going to spend 2 hours talking about why I don't; the "joke" part is that my friends probably wouldn't be surprised if I did so.);
1. A text whose literal meaning isn't true (or meant sincerely), but which would be funny had it been said sincerely.
    - example: "This is a major argument against voting rights for everybody" (said after someone did/said something stupid)
1. A text whose literal meaning is true (or meant sincerely), but which was deliberately worded in a way that's meant to be funny or absurd.
    - example: "I have seen zero penises today. I consider that an overwhelming success having just spent an hour on Omegle"
